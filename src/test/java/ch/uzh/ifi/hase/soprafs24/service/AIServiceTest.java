...
public class AIServiceTest {
  ...
  @Test
  public void generateDescription_validInput_success() throws Exception {
  ...
  @Test
  public void generateDescription_apiException_throwsException() throws Exception {
    String prompt = "test prompt";
    when(webClient.post()).thenReturn(requestBodyUriSpec);
    when(requestBodyUriSpec.uri(anyString())).thenReturn(requestBodySpec);
    when(requestBodySpec.header(anyString(), anyString())).thenReturn(requestBodySpec);
  ...
  @Test
  public void generateDescription_invalidResponse_throwsException() throws Exception {
    String prompt = "test prompt";
