...
public class AIControllerTest {
  ...
  public void callGpt35Instruct_validInput_successful() throws Exception {
      ...
      // Then the request should be successful and the response should not be null
...
public void callGpt35Instruct_aiServiceFails_handleException() throws Exception {
    ...
    given(authorizationService.isAuthorized(anyString())).willReturn(user);
    given(aiService.generateDescription(anyString())).willReturn(Optional.empty());
    ...
    // Then the request should return Bad Request status and the error message
    mockMvc.perform(postRequest)
